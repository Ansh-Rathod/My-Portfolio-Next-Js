...
const About = () => {
  ...
  return (
    <div id="about" className={` my-20`}>
      <div className={`${smallContainer} mb-20 py-10 border-t border-b`}>
        <h1 className={`${textH1} mb-5 `}>Basic wiki:</h1>
        <p className={`text-gray-500 ${textBody} `}>
          ...
          <br />
          <span className="text-black font-bold">Fav exercise:</span> lat pull
          down
          <br />
        </p>
      </div>
      <div className={`${smallContainer} mb-20 py-10 border-t border-b`}>
        <div className=" flex flex-col justify-center   ">
          <div className=" ">
            <h1 className={textH1}>HIS Story</h1>
            <p className={`text-gray-500 ${textDes} `}>
              He wrote this section BTW
            </p>
          </div>

          <div className={`mt-10  py-2 ${textBody}  `}>
            <p>
              Hello! My name is <b>Ansh Rathod</b>, I&apos;m a self-taught
              full-stack developer who wrote the first line of code in the 2020
              Corona lockdown. I think I&apos;m a fast learner & implementor so
              I have tried many trendy frameworks, and languages that come and
              gone since I started.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              I always wanted to build something of my own so I started
              observing indie makers on X/Twitter [still observing] and I have
              learned so much about what kind of product would buy and actually
              be useful for a person. [well I have made all apps that are good
              for resume only till now🙈 you can check the list somewhere on
              this site].
            </p>
            <br />
            ...
            <p>
              ...
              where user will have a number of editing tools for video, photo,
              and music files in one desktop app.
            </p>
            <br />
            <p>
              I tweeted about the paid beta version of it and turned out it is
              very simple & useful for some people I ended up making $300+ in
              the first few hours of my tweet. realized &quot;Huh I made
              something good&quot;.
            </p>
            <br />
